...
_JR Style Mod_ is a [Minecraft mod](https://minecraft.wiki/w/Mods) that allows you to use JR-style trains and station facilities
...
Head over to the  to download the mod or to see the project information.
